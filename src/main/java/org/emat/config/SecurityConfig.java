...
public class SecurityConfig {
    ...
    public SecurityConfig(
            UserRepository userRepository, EndpointRolePolicyService endpointRolePolicyService) {
    ...
    /**
     * Security filter chain configuration. Public endpoints: /users/login, /health, Swagger UI All
                                        ...
                                        .hasAnyRole(
                                                resolveRolesOrDefaults(
                                                        ...
                                                        List.of(
                                                                ...
                                                                "SIDBI_HO_CHECKER",
                                                                "SIDBI_RO")))
                                        .requestMatchers("/industry-association-registrations/**")
                                        .hasAnyRole(
                                                resolveRolesOrDefaults(
                                        ...
                                        .hasAnyRole(
                                                resolveRolesOrDefaults(
                                                        ...
                                                        List.of(
                                                                ...
                                                                "SIDBI_HO_CHECKER",
                                                                "CLUSTER_EXPERT")))
                                        .requestMatchers("/bse-recommendations/**")
                                        .hasAnyRole(
                                                resolveRolesOrDefaults(
                                                        "bseRecommendationRead",
                                                        List.of(
                                                                "BSE",
                                                                "GT_FIELD_TEAM",
                                                                "GT_PMU",
                                                                ...
                                                                "SIDBI_HO_CHECKER",
                                                                "CLUSTER_EXPERT")))
                                        .requestMatchers("/vendor-disbursements/**")
                                        .hasAnyRole(
                                                resolveRolesOrDefaults(
                                                        "bseRecommendationWrite",
                                                        List.of(
                                                                "BSE",
                                                                "GT_FIELD_TEAM",
                                                                "GT_PMU",
