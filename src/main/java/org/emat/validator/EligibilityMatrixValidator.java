...
public class EligibilityMatrixValidator {
    ...
    private static final String ELIGIBILITY_ALREADY_EXISTS_MESSAGE =
            "Eligibility Matrix already exists for Registration ID: ";
    private static final String REGISTRATION_NOT_FOUND_MESSAGE =
            "Industry Association Registration not found: ";
    private static final String ELIGIBILITY_NOT_FOUND_FOR_REGISTRATION_MESSAGE =
    ...
    public EligibilityMatrix getEligibilityByIdOrThrow(Long id) {
        return eligibilityMatrixRepository
                .findById(id)
    ...
    public EligibilityMatrix getEligibilityByRegistrationIdOrThrow(Long registrationId) {
        return eligibilityMatrixRepository
                ...
                .orElseThrow(
                        () ->
                                new RuntimeException(
                                        ELIGIBILITY_NOT_FOUND_FOR_REGISTRATION_MESSAGE
                                                + registrationId));
    }
