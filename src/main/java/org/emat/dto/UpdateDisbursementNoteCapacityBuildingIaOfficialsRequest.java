...
/** DTO for updating an existing Disbursement Note for Capacity Building of IA officials. */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class UpdateDisbursementNoteCapacityBuildingIaOfficialsRequest {
