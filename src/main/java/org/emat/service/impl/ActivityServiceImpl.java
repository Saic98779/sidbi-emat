...
public class ActivityServiceImpl implements ActivityService {
    ...
    @Override
    public ActivityStatusUpdateResponse updateActivityStatus(
            Long activityId, ActivityStatusUpdateRequest request) {
        return patchActivityStatus(activityId, request);
    }

    @Override
    public ActivityStatusUpdateResponse patchActivityStatus(
            Long activityId, ActivityStatusUpdateRequest request) {
        activityRepository
                .findById(activityId)
                .orElseThrow(() -> new RuntimeException(ACTIVITY_NOT_FOUND));
    ...
    public List<ActivityStatusResponse> getActivityStatusHistory(Long activityId) {
        return activityStatusRepository
                .findByActivityIdOrderByStatusUpdatedDtStampDesc(activityId)
                .stream()
    ...
    public ActivityStatusResponse getLatestActivityStatus(Long activityId) {
        ActivityStatus status =
                activityStatusRepository
                        .findTopByActivityIdOrderByStatusUpdatedDtStampDesc(activityId)
