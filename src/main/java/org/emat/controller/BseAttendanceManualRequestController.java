...
public class BseAttendanceManualRequestController {
    ...
    public ResponseEntity<ApiResponse<BseAttendanceManualRequestDTO>> save(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(
                        ApiResponse.created(
                                "Manual attendance request created successfully",
                                service.save(dto)));
    }

    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<BseAttendanceManualRequestDTO>> update(
            @PathVariable Long id, @RequestBody BseAttendanceManualRequestDTO dto) {
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Manual attendance request updated successfully", service.update(id, dto)));
    }
    ...
    public ResponseEntity<ApiResponse<BseAttendanceManualRequestDTO>> getById(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Manual attendance request fetched successfully", service.getById(id)));
    }
    ...
    public ResponseEntity<ApiResponse<List<BseAttendanceManualRequestDTO>>> getAll() {
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Manual attendance requests fetched successfully", service.getAll()));
    }
    ...
    public ResponseEntity<ApiResponse<List<BseAttendanceManualRequestDTO>>> getByRecommendation(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Manual attendance requests fetched successfully",
    ...
    public ResponseEntity<ApiResponse<List<BseAttendanceManualRequestDTO>>> getByApprovalStatus(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Manual attendance requests fetched successfully",
                        service.getByApprovalStatus(status)));
    }
    ...
    public ResponseEntity<ApiResponse<BseAttendanceManualRequestDTO>> reject(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Manual attendance request rejected successfully",
                        service.reject(id, approvedBy)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable Long id) {
        service.delete(id);
        return ResponseEntity.ok(
                ApiResponse.success("Manual attendance request deleted successfully", null));
    }
}
