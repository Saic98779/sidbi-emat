...
public class IndustryAssociationRegistrationMapper {
    ...
    public IndustryAssociationRegistrationResponse toResponse(
            IndustryAssociationRegistration registration) {
        return IndustryAssociationRegistrationResponse.builder()
                ...
                .sidbeApprovedByUserId(
                        registration.getSidbeApprovedByUser() != null
                                ? registration.getSidbeApprovedByUser().getId()
                                : null)
                .sidbeApprovedByUsername(
                        registration.getSidbeApprovedByUser() != null
                                ? registration.getSidbeApprovedByUser().getUsername()
                                : null)
                ...
                .currentStage(
                        registration.getCurrentStage() != null
                                ? registration.getCurrentStage().getStage()
                                        + (registration.getCurrentStage().getSubStage() != null
                                                ? "." + registration.getCurrentStage().getSubStage()
                                                : "")
                                : null)
                .build();
    }
